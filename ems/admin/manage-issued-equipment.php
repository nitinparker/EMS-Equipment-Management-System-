...
<head>
    ...
    <title>Equipment Management System | Manage Issued Equipment</title>
...
{               ?>                                      
                                        <tr class="odd gradeX">
                                            ...
                                            <a href="update-issue-equipmentdetails.php?rid=<?php echo htmlentities($result->rid);?>"><button class="btn btn-primary"><i class="fa fa-edit "></i> Edit</button> 
