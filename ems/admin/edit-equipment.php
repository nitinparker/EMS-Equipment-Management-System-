...
$query->execute();
echo "<script>alert('Equipment info updated successfully');</script>";
...
<!-- MENU SECTION END-->
    <div class="content-wrapper">
        ...
        <div class="row pad-botm">
            <div class="col-md-12">
                <h4 class="header-line">Add Equipment</h4>
...
<a href="change-equipmentimg.php?bookid=<?php echo htmlentities($result->bookid);?>">Change Equipment Image</a>
</div></div>
...
<p class="help-block">A PVMS is a Price Vocabulary of the Medical Store Number.PVMS Must be unique</p>
</div></div>
