...
$_SESSION['msg']="Equipment Returned successfully";
...
<!-- MENU SECTION END-->
    <div class="content-wrapper">
        ...
        <div class="row pad-botm">
            <div class="col-md-12">
                <h4 class="header-line">Issued Equipment Details</h4>
...
<div class="col-md-6"> 
<div class="form-group">
<label>Employee Army number :</label>
...
<button type="submit" name="return" id="submit" class="btn btn-info">Return Equipment </button>
