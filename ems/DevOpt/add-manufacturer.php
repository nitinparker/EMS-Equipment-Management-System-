    ...
    <section class="home-section">
      <nav>
        <div class="sidebar-button">
          ...
          <span class="dashboard">Add Manufacturer</span>
        </div>
        <div>
        <?php
...
<label>OEM Name <span style= "color:red">*</span></label>
...
<input class="form-control" type="number" min="6" max="999999" name="author" autocomplete="off"  required="Required"/>
</div></div>
...
<input class="form-control" type="number" name="author" autocomplete="off"  required />
</div></div>

</div>
</div>

<!-- this is for trial run for "DIV" supplier info-->
...
<button style="margin-top:35px"  type="submit" >ADD</button>
</form>
</div>
</div>
