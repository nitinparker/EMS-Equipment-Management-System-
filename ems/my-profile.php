...
echo '<script>alert("Your profile has not been updated Please Contact IT cell")</script>';
}
...
<button type="submit" name="update" class="btn btn-primary" id="submit">For Any Update Please Contact IT Cell </button> <br> <br>
<a href="Loginactivity.php" class="btn btn-primary">View Login Activity</a>
