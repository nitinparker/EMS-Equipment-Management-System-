...
<head>
    ...
    <!--[if IE]>
        ...
        <![endif]-->
    <title>Equipment Management System | Employee Signup</title>
...
<!-- MENU SECTION END-->
    <div class="content-wrapper">
        ...
        <div class="row pad-botm">
            <div class="col-md-12">
                <h4 class="header-line">Ward/Department</h4>
...
<button type="submit" name="update" class="btn btn-primary" id="submit">For Any Update Please Contact IT Cell </button>
