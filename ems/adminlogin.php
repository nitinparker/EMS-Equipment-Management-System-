...
// Function to insert login activity log
function insertLog($username, $ipAddress)
{
    global $dbh;
    $sql = "INSERT INTO admin_login_activity (username, ip_address, login_time) VALUES (:username, :ipAddress, NOW())";
...
if (isset($_POST['login'])) {
    ...
    if ($query->rowCount() > 0) {
        ...
        insertLog($username, $_SERVER['REMOTE_ADDR']);
...
<html lang="en" dir="ltr">
  <head>
  <meta charset="UTF-8" />
    <title>Equipment Management System | Admin Login</title>
    ...
    <section class="home-section">
      <nav>
        <div class="sidebar-button">
          ...
          <span class="dashboard">Admin Login Form</span>
        </div>
        <div>
        <?php
